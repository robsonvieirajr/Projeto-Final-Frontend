...
export const useAuthStore = defineStore('auth', {
  ...
  actions: {
    logIn(token, expiresIn) {
      ...
      Cookies.set('token_expiration', expirationDate.toISOString(), { expires: expirationDate });
    ...
    checkTokenExpirationOnLoad() {
      ...
      const localExpirationTime = expirationTime.toLocaleString('pt-BR', { timeZone: 'America/Sao_Paulo' });
